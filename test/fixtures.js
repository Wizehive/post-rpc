var createFixture = function (origin, libpath) {
	...
	if (!serverIframe) {
		...
		serverSource = [
			...
			'  </head>',
			'  <body>',
			'    <script type="text/javascript" src="' + libpath + '/PostRPC.Server.js"  data-cover="server"></script>',
	...
	if (!clientIframe) {
		...
		clientSource = [
			...
			'  </head>',
			'  <body>',
			'    <script type="text/javascript" src="' + libpath + '/PostRPC.Client.js"  data-cover="client"></script>',
			'    <script type="text/javascript">',
			'        try {',
